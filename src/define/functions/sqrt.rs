...
use super::public::define_function;
use super::public::test;
use super::public::AnyParseNode;
use super::public::FunctionContext;
use super::public::FunctionDefSpec;
use super::public::FunctionPropSpec;
...
fn handler(
    ...
    let index = opt_args[0];
    let body = args[0];
    return Box::new(types::sqrt {
...
fn HtmlBuilder(group: Box<dyn AnyParseNode>, options: crate::Options::Options) -> Box<dyn HtmlDomNode>{
...
fn MathMLBuilder(group: Box<dyn AnyParseNode>, options: Options) -> Box<dyn MathDomNode>{
...
fn f() -> FunctionDefSpec {
    let names = vec!["\\sqrt".to_string()];
    let props = FunctionPropSpec::new()
        .set_num_args(1)
        .set_num_optional_args(1);
}
