...
M{} {}h400000v{}h-400000z",
        622.0 + extraViniculum + hLinePad,
        extraViniculum / 2.075,
        extraViniculum,
        40.0 + extraViniculum,
        834.0 + extraViniculum,
        hLinePad,
        40.0 + extraViniculum
    );
}

fn sqrtSize1(extraViniculum: f64, hLinePad: f64) -> String {
    // size1 is from glyph U221A in the font KaTeX_Size1-Regular
    return format!(
        "M263,{}c0.7,0,18,39.7,52,119
...
M{} {hLinePad}h400000v{}h-400000z",
        601.0 + extraViniculum + hLinePad,
        extraViniculum / 2.084,
        extraViniculum,
        40.0 + extraViniculum,
        1001.0 + extraViniculum,
        40.0 + extraViniculum
    );
}

fn sqrtSize2(extraViniculum: f64, hLinePad: f64) -> String {
...
fn sqrtSize3(extraViniculum: f64, hLinePad: f64) -> String {
...
l{} -{}c4,-6.7,10,-10,18,-10 H400000
v{}H1014.6
s-87.3,378.7,-272.6,1166c-185.3,787.3,-279.3,1182.3,-282,1185
c-2,6,-10,9,-24,9
c-8,0,-12,-0.7,-12,-2z M{} {}
h400000v{}h-400000z",
        2398.0 + extraViniculum + hLinePad,
        extraViniculum / 4.223,
        extraViniculum,
        40.0 + extraViniculum,
        1001.0 + extraViniculum,
        hLinePad,
...
fn sqrtSize4(extraViniculum: f64, hLinePad: f64) -> String {
    // size4 is from glyph U221A in the font KaTeX_Size4-Regular
    return format!(
        "M473,{}
c339.3,-1799.3,509.3,-2700,510,-2702 l{} -{}
c3.3,-7.3,9.3,-11,18,-11 H400000v{}H1017.7
s-90.5,478,-276.2,1466c-185.7,988,-279.5,1483,-281.5,1485c-2,6,-10,9,-24,9
c-8,0,-12,-0.7,-12,-2c0,-1.3,-5.3,-32,-16,-92c-50.7,-293.3,-119.7,-693.3,-207,-1200
c0,-1.3,-5.3,8.7,-16,30c-10.7,21.3,-21.3,42.7,-32,64s-16,33,-16,33s-26,-26,-26,-26
s76,-153,76,-153s77,-151,77,-151c0.7,0.7,35.7,202,105,604c67.3,400.7,102,602.7,104,
606zM{} {}h400000v{}H1017.7z",
        2713.0 + extraViniculum + hLinePad,
...
fn sqrtTall(extraViniculum: f64, hLinePad: f64, viewBoxHeight: f64) -> String {
    // sqrtTall is from glyph U23B7 in the font KaTeX_Size4-Regular
    // One path edge has a variable length. It runs vertically from the viniculumn
    // to a point near (14 units) the bottom of the surd. The viniculum
    // is normally 40 units thick. So the length of the line in question is:
    let vertSegment = viewBoxHeight - 54.0 - hLinePad - extraViniculum;
...
219 661 l218 661zM702 {}H400000v{}H742z",
        extraViniculum + hLinePad,
        40.0 + extraViniculum,
        vertSegment,
        hLinePad,
        40.0 + extraViniculum
...
pub fn innerPath(name: String, height: f64) -> String {
    ...
    match name.as_str() {
        ...
        "\u{239f}" => format!("M457 0 H583 V{height} H457z M457 0 H583 V{height} H457z "),
        "\u{23a2}" => format!("M319 0 H403 V{height} H319z M319 0 H403 V{height} H319z "),
        "\u{23a5}" => format!("M263 0 H347 V{height} H263z M263 0 H347 V{height} H263z "),
        "\u{23aa}" => format!("M384 0 H504 V{height} H384z M384 0 H504 V{height} H384z "),
        "\u{23d0}" => format!("M312 0 H355 V{height} H312z M312 0 H355 V{height} H312z "),
        "\u{2016}" => format!(
...
lazy_static! {
    static ref svg_path:Mutex<HashMap<&'static str,&'static str> > = Mutex::new({
...
#[wasm_bindgen]
pub fn path_get(key:String) -> String {
    let res = svg_path.lock().unwrap().get(key.as_str()).unwrap().to_string();
    return res;
}
